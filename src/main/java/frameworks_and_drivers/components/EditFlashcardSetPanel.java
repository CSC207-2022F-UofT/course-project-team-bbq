...
public class EditFlashcardSetPanel extends JPanel implements ActionListener {
    private final EditFlashcardsSetController controller;
     ...
     */
    public EditFlashcardSetPanel(EditFlashcardsSetController controller, FlashcardSetDsRequestModel flashcardSet, JFrame editPage){
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getActionCommand().equals("Cancel")){
            ...
            try{
                EditFlashcardSetResponseModel newFlashcardSet = controller.edit(numId, newTerm, newDefinition);
            ...
            catch (EditFlashcardSetFailed error){
