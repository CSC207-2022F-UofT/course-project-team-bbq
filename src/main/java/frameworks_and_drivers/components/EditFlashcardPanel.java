...
public class EditFlashcardPanel extends JPanel implements ActionListener {
     ...
     */
    public EditFlashcardPanel(EditFlashcardController controller, FlashcardDsRequestModel flashcard, JFrame editPage){
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getActionCommand().equals("Cancel")){
            ...
            try{
                EditFlashcardResponseModel newFlashcard = controller.edit(numId, newTerm, newDefinition);
            ...
            catch (EditFlashcardFailed error){
