...
public class CommonUserDataAccess implements IUserDataAccess {
        ...
        private void save() {
            ...
            try {
                ...
                for (CommonUserDsRequestModel user : accounts.values()) {
                    StringBuilder line = new StringBuilder(String.format("%s, %s, %s", user.getUsername(),
        ...
        public void saveFlashcardSetID(String username, int FlashcardSetID) {
            ...
            CommonUserDsRequestModel newUser = new CommonUserDsRequestModel(oldUser.getUsername(),
                    oldUser.getPassword(), oldUser.getIsAdmin(), newFlashcardSet);
