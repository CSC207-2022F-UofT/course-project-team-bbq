 ...
 * @author Thomas Shim
 */
public class EditFlashcardSetInteractor implements EditFlashcardSetInputBoundary {
    private final DBGateway dbGateway;
    private final EditFlashcardSetOutputBoundary fcSetEditorOB;
     ...
     */
    public EditFlashcardSetInteractor(DBGateway dbGateway, EditFlashcardSetOutputBoundary fcSetEditorOB){
     ...
     */
    @Override
    public EditFlashcardSetResponseModel edit(EditFlashcardSetRequestModel requestModel) {
        ...
        //If not empty, we edit the flashcard set via the dbGateway, and then we return success view.
            ...
            EditFlashcardSetResponseModel responseModel = new EditFlashcardSetResponseModel(fcSetId, titleEdit, descriptionEdit);
